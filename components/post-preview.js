...
// console.log(titleArr);
  ...
  return (
    ...
    <div className="z-10 py-6 text-white/90 hover:text-white/100 absolute inset-x-0 bottom-0  hover:bg-black hover:bg-opacity-20">
      <div className="absolute flex justify-between items-end inset-x-0 bottom-0 leading-none bg-gradient-to-b from-transparent to-black
      text-5xl font-medium sm:text-6xl 2xl:text-7xl p-2 sm:p-4 lg:p-6 drop-shadow-lg tracking-tight md:tracking-normal
      "
      style={{
...
modifiedTitle
      ...
      <div className="text-xl sm:text-2xl lg:text-3xl bg-gray-900 bg-opacity-10 rounded"   style={{
