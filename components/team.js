...
const people = [
  ...
  export default function Team() {
    return (
        <>
         <div className="relative bg-main-primary">
      <div className="absolute inset-0">
        <img
          className="w-full h-full object-cover"
          src="https://res.cloudinary.com/annaga/image/upload/v1636486537/bear_gsipdp.jpg"
          alt=""
        />
        <div className="absolute inset-0 bg-main-primary mix-blend-multiply" aria-hidden="true" />
      </div>
      ...
      <div className="bg-white">
        <div className="mx-auto pt-16 py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
